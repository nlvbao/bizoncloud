...
CREATE TABLE account (
                         ...
                         authentication_success_last_date     timestamp(6),
...
CREATE TABLE cookie (
                        ...
                        CONSTRAINT bizonclouds_cookie_pkey
...
CREATE TABLE document (
                          ...
                          CONSTRAINT bizonclouds_document_pkey
                              PRIMARY KEY (id));
...
CREATE TABLE domain_abstract (
                                 ...
                                 purge_step          varchar(255) DEFAULT 'IN_USE' NOT NULL,
                                 CONSTRAINT bizonclouds_domain_abstract_pkey
                                     PRIMARY KEY (id));
CREATE TABLE domain_access_policy (
                                      id                int8 NOT NULL,
                                      creation_date     timestamp(6) NOT NULL,
                                      modification_date timestamp(6) NOT NULL,
                                      CONSTRAINT bizonclouds_domain_access_policy_pkey
                                          PRIMARY KEY (id));
CREATE TABLE domain_access_rule (
                                    ...
                                    rule_index              int4,
                                    CONSTRAINT bizonclouds_domain_access_rule_pkey
                                        PRIMARY KEY (id));
CREATE TABLE domain_policy (
                               ...
                               CONSTRAINT bizonclouds_domain_policy_pkey
                                   PRIMARY KEY (id));
CREATE TABLE entry (
                       id                 int8 NOT NULL,
...
CREATE TABLE functionality (
                               ...
                               CONSTRAINT bizonclouds_functionality_pkey
                                   PRIMARY KEY (id));
...
CREATE TABLE functionality_integer (
                                       ...
                                       CONSTRAINT bizonclouds_functionality_integer_pkey
                                           PRIMARY KEY (functionality_id));

CREATE TABLE functionality_string (
                                      functionality_id int8 NOT NULL,
                                      string_value     varchar(255),
                                      CONSTRAINT bizonclouds_functionality_string_pkey
                                          PRIMARY KEY (functionality_id));
...
CREATE TABLE functionality_unit (
                                    ...
                                    default_value_used    bool DEFAULT 'true' NOT NULL,
                                    max_value_used    bool DEFAULT 'true' NOT NULL,
                                    CONSTRAINT bizonclouds_functionality_unit_pkey
                                        PRIMARY KEY (functionality_id));
...
CREATE TABLE ldap_connection (
                                 ...
                                 creation_date        timestamp NOT NULL,
                                 modification_date    timestamp NOT NULL,
                                 CONSTRAINT bizonclouds_ldap_connection_pkey
                                     PRIMARY KEY (id));
CREATE TABLE log_entry (
                           ...
                           expiration_date  timestamp,
                           CONSTRAINT bizonclouds_log_entry_pkey
                               PRIMARY KEY (id));
CREATE TABLE policy (
                        id              int8 NOT NULL,
                        ...
                        system         bool NOT NULL,
                        CONSTRAINT bizonclouds_policy_pkey
                            PRIMARY KEY (id));
CREATE TABLE recipient_favourite (
                                     ...
                                     CONSTRAINT bizonclouds_recipient_favourite_pkey
                                         PRIMARY KEY (id));
CREATE TABLE anonymous_url (
                               ...
                               CONSTRAINT bizonclouds_secured_url_pkey
                                   PRIMARY KEY (id));
...
CREATE TABLE share_expiry_rules (
                                    ...
                                    CONSTRAINT bizonclouds_share_expiry_rules_pkey
...
CREATE TABLE signature (
                           ...
                           cert              text,
                           sort_order        int4,
                           CONSTRAINT bizonclouds_signature_pkey
                               PRIMARY KEY (id));
...
CREATE TABLE unit (
                      ...
                      CONSTRAINT bizonclouds_unit_pkey
                          PRIMARY KEY (id));
CREATE TABLE version (
                         id                int8 NOT NULL,
                         version           text NOT NULL UNIQUE,
                         creation_date     timestamp(6) NOT NULL,
                         CONSTRAINT bizonclouds_version_pkey
                             PRIMARY KEY (id));
